...
export const connect = (walletName = '') => {
  ...
  return async (dispatch) => {
    ...
    // NFT ABI
    const abiResponse = await fetch(`${homepagePath}/config/nft_abi.json`, {
      headers: {
    ...
    // Staking ABI
    const stakeAbiResponse = await fetch(`${homepagePath}/config/stake_abi.json`, {
      headers: {
        "Content-Type": "application/json",
        Accept: "application/json",
      },
    ...
    const coinbaseWallet = new CoinbaseWalletSDK({
      ...
      appLogoUrl: `${homepagePath}/config/images/logo.png`,
      darkMode: false
    })
